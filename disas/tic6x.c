...
#include "disas/tic6x/tic6x-insn-formats.h"
#undef FMT
  };
...
#include "disas/tic6x/tic6x-control-registers.h"
#undef CTRL
  };
...
#include "disas/tic6x/tic6x-opcode-table.h"
#undef INSN
#undef INSNE
  };
